                ...
                <div class=" col-md-6 col-lg-6 col-md-offset-3">
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
                        <td>Doctor Name: </td>
                        <td><a href=""> <?php echo $appointment['Doctor']['name']?></a></td>
                      </tr>
                      <tr>
                        <td>Patient Name: </td>
                        <td><a href="<?php echo $this->Html->url(array('controller' => 'patients', 'action' => 'doctors_view',$appointment['Patient']['id']), true);?>"> <?php echo $appointment['Patient']['name']?></a></td>
                      </tr>
                      <tr>
                ...
                <!--  <a href="#" class="btn btn-primary">Button 2</a>-->
                 ...
                 <div class="panel-footer">
                        ...
                        <span class="pull-right">
                            <a href="<?php echo $this->Html->url(array('controller' => 'appointments', 'action' => 'doctors_edit',$appointment['Appointment']['id']), true);?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
                            ...
                            echo $this->Form->postLink(
                              ...
                              array(
                              'action'   => 'delete_doc', $appointment['Appointment']['id']
                              ),
                              array(
                              'class'    => 'tip',
                              'escape'   => false,
