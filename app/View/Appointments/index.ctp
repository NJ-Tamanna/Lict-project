                    ...
                    <div class="box-header">
                        <h3 class="box-title">My Details</h3>
										...
										<div class="table-responsive">
											<h2><?php echo __('Appointments List'); ?></h2>
											...
											<tr>
													...
													<th><?php echo $this->Paginator->sort('appoint_date'); ?></th>
                        ...
                        <td><?php
                            $a = $appointment['Appointment']['appoint_date'];
                            $b = explode(" ",$a);
                            echo h($b[0]);

                        ?>&nbsp;</td>
                        <td><?php
                            $a = $appointment['Appointment']['created'];
                            $b = explode(" ",$a);
                            echo h($b[0]);

                        ?>&nbsp;</td>
                        <td><?php
                            $a = $appointment['Appointment']['modified'];
                            $b = explode(" ",$a);
                            echo h($b[0]);
                        ...
                        <td class="actions">
                          ...
                          <a href="<?php echo $this->Html->url(array('controller' => 'appointments', 'action' => 'view',$appointment['Appointment']['id']), true);?>" data-original-title="view this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-info-sign"></i></a>
