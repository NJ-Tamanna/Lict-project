                ...
                <div class="box box-primary">
                  ...
                  <div class="panel-footer">
                         ...
                         <span class="pull-right">
                             <a href="<?php echo $this->Html->url(array('controller' => 'patients', 'action' => 'edit', $patient['Patient']['id']), true);?>" data-original-title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-sm btn-warning" disabled><i class="glyphicon glyphicon-edit"></i></a>
                             ...
                             echo $this->Form->postLink(
                               '<button class="btn btn-sm btn-danger" data-original-title="Remove this user" data-toggle="tooltip" disabled>
